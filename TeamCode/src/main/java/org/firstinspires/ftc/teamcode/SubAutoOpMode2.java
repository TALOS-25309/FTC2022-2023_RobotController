...
@Autonomous(name = "Sub Auto (Right)", group = "")
public class SubAutoOpMode2 extends LinearOpMode
{
    ...
    private void procedure_run(){
        switch (this.step){
            ...
            case 6:
                ...
                break;
            case 7:
                //this.wheel_part.start_step("sub rotate home right");
                break;
            case 8:
                this.wheel_part.start_step("sub go right parking");
                break;
        }
        this.step++;
    }
