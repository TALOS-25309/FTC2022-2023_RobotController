...
public class Gyro {
    ...
    public void update()
    {
        //telemetry.addData("Cur Deg", this.get_rotation(AngleUnit.DEGREES));
        if(!this.finish()){
            double f_degree = this.get_rotation(AngleUnit.DEGREES)/* + (double)this.dir * 0.5*/;
    ...
    public void activate(double target_degree, Wheel.Direction dir){
        ...
        this.target_degree = this.set_degree(target_degree);
        ...
        this.i_degree -= this.dir;
        this.finish = false;
    }

    public void correction(){
        this.i_degree = this.get_rotation(AngleUnit.DEGREES);
        //this.telemetry.addData("Correction", String.valueOf(i_degree) + " " + String.valueOf(this.target_degree));
        this.dir *= -1;
        this.i_degree -= this.dir;
        this.finish = false;
    }
